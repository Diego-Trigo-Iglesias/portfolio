...
const cls = computed(() => ["hologram-box", { "hologram-box-has-title": !!slots.title }]);
</script>
  ...
  <div :class="cls" ref="wrapper">
    <div class="hologram-box-header" v-if="slots.title">
      ...
      <div class="hologram-box-curve">
        <svg viewBox="0 0 51 34" fill="none" xmlns="http://www.w3.org/2000/svg" class="hologram-box-curve-svg">
          ...
          <path d="M0 1H3.12195C26.5366 1 24.1951 33 47.6098 33H50.7317" vector-effect="non-scaling-stroke" class="hologram-box-curve-path" />
        </svg>
      </div>
    ...
    <div class="hologram-box-footer" v-if="props.footer">
      <svg class="hologram-box-footer-svg" viewBox="0 0 255 13" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M0.257324 0.428772L14.3995 8.91406C18.1502 11.1645 23.2373 12.4288 28.5416 12.4288H225.973C231.277 12.4288 236.364 11.1645 240.115 8.91405L254.257 0.428772" class="hologram-box-footer-path" vector-effect="non-scaling-stroke" />
      </svg>
    </div>
  </div>
</template>
...
.hologram-box {
  ...
  &-header {
    ...
    &-notch-right {
      ...
      height: var(--radius-md);
      border: var(--stroke-md) solid var(--color-cyan-400);
      border-width: var(--stroke-md) var(--stroke-md) 0 0;
